...
// THESE FUNCTIONS CAN BE DELETED ONCE WE USE A LATER VERSION OF GO
// THE 1.10.8 VERSION OF GO ADDS A RANDOM VALUE AS THE SUFFIX WHICH
// MAY CAUSE ISSUES FOR FILE NAMING (Dentrix ImportDocument)
//
// Random number state.
